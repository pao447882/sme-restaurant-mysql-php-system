<?php
	...
	if (isset($_GET['delete_id'])) {
        ...
        $delete_query = "DELETE FROM employee WHERE employee_id = $delete_id";

        $delete_result = mysqli_query($conn, $delete_query);

        if ($delete_result) {
            header('Location: employee_account.php'); // Redirect to admin dashboard after successful delete
            exit();
        } else {
...
<html>
<head>
	<title>Employee & Account Page</title>
...
<body>
	<div class="container" >
		<h3 style="margin-bottom : 12px;">Employee & Account Page</h3>
		...
		<div class="button-container">
			...
			<button class="btn-head" onclick="location.href='create_new_employee.php';">Create New Employee</button>		
		</div>
	</div>
	...
	<div style = "text-align : center;">
		...
		<form class = "input_form" class="search_name_form" name="searchnameform" id="searchnameform">
			<div class="search_input">
				<label for="textsearch" >Insert Name</label>
				<input type="text" name="emp_name" id="emp_name" class="text_search" placeholder="&nbsp;Employee Name">
			...
			<form>
                <div style="margin-top: 10px;">
                    ...
                    <label for="show_all">&nbsp; Show All Employees</label><br>
                </div>
            </form>
        </form>	
		...
		<script type="text/javascript">
			...
			$(function() {
				$("#emp_name").autocomplete({
					source: "php/php_employee_search.php",
				});
				...
				$("#btnSrch").click(function() {
					...
					$.ajax({
						url: "php/php_employee_admin_get.php",
						type: "post",
						data: {emp_name: $("#emp_name").val(), branch : <?php echo $branch; ?> , show_all : show_all_emp},
