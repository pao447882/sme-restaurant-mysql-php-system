<?php
	...
	if($_SESSION['Role'] != "admin") {
        #$alert_msg = "This page for Admin only !!!";
...
<html>
<head>
	<title>Admin Page Test ver 1.0</title>
...
<body>
	<div class="container" >
		<h3 style="margin-bottom : 12px;">Admin Page</h3>
	...
	<div class="inline_menu">
		<ul>
			<li class="menu-li"><a href="employee_account.php">Employee & Account</a></li>
